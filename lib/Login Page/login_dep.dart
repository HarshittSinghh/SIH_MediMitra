...
void main() {
  runApp(const LoginDept());
}

class LoginDept extends StatelessWidget {
  const LoginDept({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Flutter Demo',
      theme: ThemeData(
        primaryColor: const Color(0xFF7CB8C0), // Primary color
        colorScheme: ColorScheme.light(
          primary: const Color(0xFF7CB8C0), // Primary color
        ...
        buttonTheme: ButtonThemeData(
          buttonColor: const Color(0xFF7CB8C0), // Primary color for buttons
